local hsluv = require("srcery.utils.hsluv")
...
function util.terminal(cp)
    g.terminal_color_0 = cp.black
    g.terminal_color_8 = cp.brightBlack

    g.terminal_color_1 = cp.red
    g.terminal_color_9 = cp.brightRed

    g.terminal_color_2 = cp.green
    g.terminal_color_10 = cp.brightGreen

    g.terminal_color_3 = cp.yellow
    g.terminal_color_11 = cp.brightYellow

    g.terminal_color_4 = cp.blue
    g.terminal_color_12 = cp.brightBlue

    g.terminal_color_5 = cp.magenta
    g.terminal_color_13 = cp.brightMagenta

    g.terminal_color_6 = cp.cyan
    g.terminal_color_14 = cp.brightCyan

    g.terminal_color_7 = cp.white
    g.terminal_color_15 = cp.brightWhite
end
...
function util.load(theme)
    ...
    if require("srcery.config").options["term_colors"] then
